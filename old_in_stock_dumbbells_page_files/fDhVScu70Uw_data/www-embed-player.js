...
sf("//web.archive.org/web/20200204215129/https://static.doubleclick.net/instream/ad_status.js",a);Df.push(Af(function(){Ef||"google_ad_status"in window||(yf("//web.archive.org/web/20200204215129/https://static.doubleclick.net/instream/ad_status.js",a),Ef=!0,P("DCLKSTAT",3))},5E3))}}
...
b=He("//web.archive.org/web/20200204215129/https://googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof ld&&b.abort();
return id(c)})}
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&Kf.dispose();a=0;for(var b=Df.length;a<b;a++){var c=Df[a];if(!isNaN(c)){var d=A("yt.scheduler.instance.cancelJob");d?d(c):T(c)}}Df.length=0;xf("//web.archive.org/web/20200204215129/https://static.doubleclick.net/instream/ad_status.js");Ef=!1;P("DCLKSTAT",0);Cd(ij,hj);if(a=gj)a.removeEventListener("onScreenChanged",lj),a.removeEventListener("onLogClientVeCreated",kj),a.removeEventListener("onLogServerVeCreated",mj),a.removeEventListener("onLogVeClicked",nj),a.removeEventListener("onLogVesShown",
oj),a.destroy();jj={}});
...
/*
     FILE ARCHIVED ON 21:51:29 Feb 04, 2020 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 00:16:17 Jul 20, 2020.
...
playback timings (ms):
  esindex: 0.024
  LoadShardBlock: 714.173 (3)
  exclusion.robots.policy: 0.288
  RedisCDXSource: 1.551
  PetaboxLoader3.resolve: 90.192 (2)
  load_resource: 160.347
  CDXLines.iter: 19.413 (3)
  PetaboxLoader3.datanode: 763.803 (5)
  exclusion.robots: 0.307
  captures_list: 809.849
*/